  ...
  <div class="min-h-screen bg-slate-950 text-slate-50 flex flex-col">
      ...
      <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
        <div class="flex items-center gap-3">
          <div>
            ...
            <p class="text-xs sm:text-sm text-slate-400">Spotify stats, zero tracking.</p>
          </div>
        </div>
            ...
            <div>
              <div
                class="inline-flex items-center gap-2 px-2 py-1 rounded-full
                       ...
                       text-xs sm:text-sm text-emerald-200 mb-4"
              >
              ...
              <p class="text-base sm:text-lg text-slate-300 mb-6 max-w-xl">
            ...
            <div id="preview" class="relative">
              ...
              >
                <div class="flex items-center justify-between mb-4">
                  <div>
                    <p class="text-xs sm:text-sm text-slate-400">Your session</p>
                    <p class="text-sm sm:text-base font-medium text-slate-100">Listening time today</p>
                  </div>
                  <p class="text-2xl sm:text-3xl font-semibold text-emerald-400">3h 42m</p>
                </div>

                <div class="grid grid-cols-3 gap-3 text-xs sm:text-sm">
                  <div class="rounded-2xl bg-slate-900/70 border border-white/5 p-3">
                    <p class="text-[11px] sm:text-xs text-slate-400 mb-1">Top artist</p>
                    <p class="font-semibold text-sm mb-1 truncate">Fred again..</p>
                    <p class="text-[11px] sm:text-xs text-emerald-300">128 minutes</p>
                  </div>
                  <div class="rounded-2xl bg-slate-900/70 border border-white/5 p-3">
                    <p class="text-[11px] sm:text-xs text-slate-400 mb-1">Top track</p>
                    <p class="font-semibold text-sm mb-1 truncate">B.O.T.A.</p>
                    <p class="text-[11px] sm:text-xs text-emerald-300">72 plays</p>
                  </div>
                  <div class="rounded-2xl bg-slate-900/70 border border-white/5 p-3">
                    <p class="text-[11px] sm:text-xs text-slate-400 mb-1">Favourite genre</p>
                    <p class="font-semibold text-sm mb-1 truncate">Electronic</p>
                    <p class="text-[11px] sm:text-xs text-emerald-300">36%</p>
                  </div>
                </div>
      ...
      <div class="max-w-6xl mx-auto px-4 py-10 lg:py-14">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <article class="rounded-2xl border border-white/10 bg-slate-900/60 p-4 flex flex-col gap-2">
            ...
            <ul class="mt-2 text-xs sm:text-sm text-slate-400 space-y-1">
              <li>• Direct “open in Spotify” links</li>
              <li>• Sortable by period</li>
          ...
          <article class="rounded-2xl border border-amber-400/40 bg-amber-400/5 p-4 flex flex-col gap-2">
            <div class="flex items-center gap-2">
              <h3 class="text-base font-semibold text-amber-300">Top albums</h3>
              <span
                class="px-2 py-0.5 rounded-full text-[10px] uppercase tracking-[0.16em]
            ...
            <p class="text-sm text-amber-100/90">
              ...
              This isn't provided by Spotify's API yet, but is something I can build on top of your
              existing listening data.
            </p>
            <ul class="mt-2 text-xs sm:text-sm text-amber-200/90 space-y-1">
              <li>• Your most played albums overall</li>
              <li>• Sort by period and artist</li>
    ...
    <section id="how-it-works">
      <div class="max-w-6xl mx-auto px-4 py-10 lg:py-14">
        ...
        <div class="grid gap-5 md:grid-cols-3">
          ...
          <article class="rounded-2xl border border-white/10 bg-slate-900/60 p-4 flex flex-col gap-2">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-emerald-300">1. Log in with Spotify</h3>
          ...
          <article class="rounded-2xl border border-white/10 bg-slate-900/60 p-4 flex flex-col gap-2">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-emerald-300">2. Secure token exchange</h3>
          ...
          <article class="rounded-2xl border border-white/10 bg-slate-900/60 p-4 flex flex-col gap-2">
            <div class="flex items-center justify-between">
              <h3 class="text-base font-semibold text-emerald-300">3. Fetch & render your stats</h3>
              <span class="text-[11px] px-2 py-0.5 rounded-full bg-slate-800/80 text-slate-200 border border-slate-600/70">
                Spotify Web API
              </span>
            </div>
        ...
        <div class="mt-8 rounded-2xl border border-dashed border-emerald-400/40 bg-emerald-400/5 p-4 text-sm text-emerald-50 space-y-2">
          ...
          <p class="text-emerald-100/90">
            In other words: your data is yours, and TunePulse never stores anything beyond
            an anonymized analytics cookie.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-6xl mx-auto px-4 py-10 lg:py-14">
        ...
        <div class="grid lg:grid-cols-[1.4fr_1fr] gap-6 items-start">
          ...
          <article class="rounded-2xl border border-white/10 bg-slate-900/60 p-5 flex flex-col gap-3">
            <h3 class="text-base font-semibold text-emerald-300">A privacy-first approach</h3>
            ...
            <p class="text-sm text-slate-300 leading-relaxed">
              However, the site does use two essential third-party tools to function properly:
            </p>

            <ul class="mt-1 text-xs sm:text-sm text-slate-400 space-y-1">
              <li>• <span class="font-semibold text-slate-300">Plausible Analytics:</span> privacy-focused, cookie-free stats</li>
              <li>• <span class="font-semibold text-slate-300">Cloudflare Tunnels:</span> protect my infrastructure</li>
            </ul>

            <p class="text-sm text-slate-300 leading-relaxed">
              These tools help me understand overall usage (page views, countries, browser types)
              without ever identifying you. No cookies, no fingerprinting, no cross-site tracking, and Cloudflare protects my infrastructure
              without logging any personal data.
            </p>
            ...
            <p class="text-sm text-slate-300 leading-relaxed mt-2">
              ...
              improvements. If you’re curious, feel free to explore the full source code on GitHub.
            </p>
          </article>

          <!-- Right column -->
          <article class="rounded-2xl border border-emerald-400/40 bg-emerald-400/5 p-5 flex flex-col gap-3">
            <h3 class="text-base font-semibold text-emerald-300">Explore the code</h3>
    ...
    <footer class="border-t border-white/5 bg-slate-950/90">
      <div class="max-w-6xl mx-auto px-4 py-4 text-[13px] sm:text-sm text-slate-400 flex justify-between">
